...
document.querySelector('.category-para').innerHTML='Products Under '+category+' Category'
var products
// default filter type
var filterType = 'any'
...
function getCategoryProducts(type, min, max){
    ...
    products.forEach((product) => {
        if(product.category==category&&type=='any'){
            productContent(productsContainer, product)
        }
        else if(product.category==category&&type=='range'&&product.price>=min&&product.price<=max){
            productContent(productsContainer, product)
        }
        else if(product.category==category&&type=='openRange'&&product.price>=min){
            productContent(productsContainer, product)
        }
